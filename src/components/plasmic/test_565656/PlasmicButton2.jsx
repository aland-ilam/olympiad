...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: JzEs4dPI9Ib6/css
import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: Q2rP-czP2YCk/icon
import Icon38Icon from "./icons/PlasmicIcon__Icon38"; // plasmic-import: 8XSfzepQ3lx1/icon
    ...
    <Stack__
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootshape_sharp_color_green]:
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__mqw2J)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon38Icon
                className={classNames(projectcss.all, sty.svg___6FMq)}
                role={"img"}
              />
            ),
